...
public class RegisterController{
	...
	public String doStuRigesterSubmit(HttpServletRequest req,
		...
		IUserTableDAOService userService=(IUserTableDAOService)BeanFactory.getBean("IUserTableDAOService");
		boolean isExist=false;
		isExist=userService.isStuNumberExist(stuNumber);
		if(!isExist){//学号没有被注册
			//检验其它数据
			...
			boolean flag=userService.doInsertAStu(user);
			if(flag){
				...
				user=userService.getUserByLogin(e);
				//将用户写入Session
