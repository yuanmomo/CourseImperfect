...
public class SelectionController {
	...
	//    8 学生当前还没有进行选题
	//    9 对不起，该课题所属老师带生人数已经达到上限。请刷新选题列表！！
	...
	public String doSelect(int id, ModelMap map, HttpServletRequest request) {
		...
		ITimeTableDAOService dao=(ITimeTableDAOService)BeanFactory.
		...
		try {
			...
			json=business.doSelect(user, teacher, id, course, userDao, courseDao);
			// 刷新Session中的学生用户信息
