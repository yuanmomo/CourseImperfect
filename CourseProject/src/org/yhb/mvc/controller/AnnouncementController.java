...
public class AnnouncementController {
	...
	public String viewUser(HttpServletRequest request, ModelMap modelMap)
		...
		if (idStr != null && !"".equals(idStr)) {
			...
			IAnnouncementDAOService dao = (IAnnouncementDAOService) BeanFactory
					.getBean("IAnnouncementDAOService");
			Announcement news = dao.getAnnouncementById(id);
	...
	public String deleteAnnouncement(HttpServletRequest request, ModelMap modelMap)
			throws Exception {
	...
	public String viewNewsList(HttpServletRequest request, ModelMap map) {
		...
		// 页面左边边栏操作栏目
		String leftBar = BuildLeftBar.build(user, FinalDatas.xmlFileBasicLocation,null);
	...
	public String editNews(HttpServletRequest request, ModelMap map) {
		...
		if (idStr != null && !"".equals(idStr)) {
			...
			// 初始化右边的编辑窗口
			Announcement news = ((IAnnouncementDAOService) BeanFactory
					.getBean("IAnnouncementDAOService"))
